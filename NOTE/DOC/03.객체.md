...
- 스케줄 비/활성화
BEGIN
    DBMS_SCHEDULER.enable('Job명');     -- 활성화
    DBMS_SCHEDULER.disable('Job명');     -- 비활성화
END;/

- 스케줄 삭제
BEGIN
    DBMS_SCHEULER.drop_job('Job명');
END;/

...
SET SERVEROUTPUT ON;
DECLARE
    -- 테이블 department 의 부서코드(dept_id) 컬럼을 참조
    -- 테이블.컬럼%TYPE : 컬럼의 데이터타입을 참조하여 지정
...
-- 109. LOOP문을 이용하여 구구단을 출력하는 PL/SQL 블록을 작성하시오
DECLARE
    dan NUMBER := 2;    -- 단
    i   NUMBER := 1;    -- 곱하는 수
BEGIN
...
-- 110. WHILE LOOP문을 이용하여 구구단을 출력하는 PL/SQL 블록을 작성하시오
DECLARE
    dan NUMBER := 2;    -- 단
    i   NUMBER := 1;    -- 곱하는 수
BEGIN
...
-- 111. FOR LOOP문을 이용하여 구구단을 출력하는 PL/SQL 블록을 작성하시오
DECLARE
    dan NUMBER := 2;    -- 단
    i   NUMBER := 1;    -- 곱하는 수
BEGIN
...
-- 112. 반복문을 활용한 1 ~ 20 사이의 정수 중 홀수만 출력하는 PL/SQL문을 작성하시오.
DECLARE
    i NUMBER := 1;
BEGIN
    WHILE i <= 20 LOOP
...
/
/*
    113.테이블 employee 와 department를 조인하여
...
/
---------------------------------------------------------------
-- 114. 사원번호와 부서명을 구하는 함수를 정의하는 PL/SQL을 작성하시오.
-- 함수 생성
